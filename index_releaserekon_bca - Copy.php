...
<head>
    ...
    function getTglRelease(){ 
        tgl_release = $("input[name=tgl_release]")
        ...
        if(tgl_release.val()==""){
          ...
          $.ajax({
            ...
            data: {'action':'request.settlement.vabca','tgl_release':tgl_release.val()},
            beforeSend:function(){
            ...
            success: function(response) {
                ...
                // console.log(resObj.data[0].trxdate);
                ...
                if (resObj.data.length>0) {
                    ...
                    markup = "<tr>"+
                                ...
                                "<td style=\"text-align: center;\">"+resObj.data_query[0].TransactionDate+"</td>"+
                                "<td style=\"text-align: center;\">"+resObj.data[0].trxdate+"</td>"+
                                
                                "<td style=\"text-align: right;\">"+parseInt(resObj.total).toLocaleString()+"</td>"+
                                "<td style=\"text-align: right;\">"+parseInt(resObj.data_query[0].PaidAmount).toLocaleString()+"</td>"+
                                "<td style=\"text-align: center;\">"+"<button id=\"btn_rinci\" name=\"btn_rinci\" data-trxdate=\""+resObj.data_query[0].Norek+"\" data-settlement=\"5,000,000\" data-payment=\"5,000,000\">Rinci</button>"+"</td>"+ 
    ...
    tgl_release_input = $("input[name=tgl_release_input]")
    if(tgl_release_input.val()==""){
            alert("Tanggal tidak boleh kosong")
        }else{
      ...
      if (id_x==0) {
        ...
        if (id_x<globResObj.length) {
          $.ajax({
                ...
                type: 'POST',
                url: 'module/payment/bcava/action_api.php',
                data: {'action':'rilis.vabni','tgl_release_input':tgl_release_input.val(),'custcode':globResObj[id_x].contractno, 'traceno':globResObj[id_x].TraceNo},
                beforeSend:function(){
                ...
                <table class="table table-bordered" id="data-table" border="1px solid rgb(190,190,190);">
                    <thead>
                        <tr>
                          ...
                          <th style="width: 8%;">TANGGAL SETTLEMENT</th>
                          <th style="width: 8%;">SETTLEMENT</th>
                          <th style="width: 8%;">PAYMENT VA</th>
                          <th style="width: 2%;"></th>
                    ...
                    <tbody>
                        ...
                        <!-- <tr>
                          ...
                          <td style="text-align:right;">4,000,000</td>
                          <td style="text-align:center;"><button id="btn_rinci" name="btn_rinci" data-txndate="01/04/2021" data-settle="4,000,000" data-payment="4,000,000">Rinci</button></td>
                        </tr>
                        <tr>
                          ...
                          <td style="text-align:right;">5,000,000</td>
                          <td style="text-align:center;"><button id="btn_rinci" name="btn_rinci" data-txndate="03/04/2021" data-settle="5,000,000" data-payment="5,000,000">Rinci</button></td>
                        </tr> -->
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7" style="padding-bottom: 10px;">
            <div class="card">
                ...
                <div class="body" id="rinci_waivedenda">
                    <div id="loading" class="loading" style="display: none; vertical-align: middle; text-align: center;">
...
<!-- /***************************************************** **/ -->
       ...
       <div class="panel panel-default" id="row_form">
            <div class="panel-body">
            <div class="container-fluid">
                <div class="row" style="display: none;">
                    <div class="progress">
                ...
                <div class="row" >
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 10%;"><input  name="total_amount" type="text" id="total_amount" readonly="" class="inpSmall" maxlength="50" size="15" value="<?php echo $_POST['total_amount'];?>" style="padding:5px 10px; width: 100%; background-color: #dce3e3; text-align: right;" /></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td>Tanggal Release</td>
                            <td>:</td>
                            <td><input  name="tgl_release_input" type="text" id="tgl_release_input" readonly="" class="inpSmall" maxlength="50" size="15" value="<?php echo $_POST['tgl_release_input'];?>" style="padding:5px 10px; width: 100%; height: ;" /></td>
                        </tr>
                        <tr>
                            <td colspan="4">&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="3" align="right">
                                <button class="btn btn-sm btn-success" disabled="" style="width: 50%; height: 35px; font-size: 12px;" onclick="getDoRelease(0)" id="trf_post_klik" value="post_klik" name="post_klik"><i class="glyphicon glyphicon-check" style="width: 20px;"> </i><b>RECON RELEASE</b></button>            
                            </td>
                            <td></td>
                        </tr>
                    </table>                                             
    ...
    <script>
      $(document).ready(function(){
        ...
        $("button").on('click','.btn_rinci')(function(e){
            e.preventDefault();
            alert('tes');
            ...
            // console.log(txndate, settlement, payment);
